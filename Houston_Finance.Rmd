...
Records: The data for this project comes from [The City of Houston Open Data](https://data.houstontx.gov/), which is updated and maintained by the City Secretary's Office. The excel sheet lists a detailed history of campaign finance transactions, containing  candidates, amounts, and donor information, from a period of 2007-2019. 

Using the records, we can hopefully shed some more light on the background and motivation of local political donors. While the sheet has lacked sufficient updating, and its most recent update was in 2018, a lot of the individuals listed in the document are still currently in office, and it would be interesting to see an expansive story on where they get all their campaign money, and how it influences their decisions. 

Visuals: A map plotting out all the locations of people who have contributed to local elections in Houston politics, just from a preliminary examination, it looks like there are many donors who are from cities outside the state like San Francisco, Michigan, etc.
...
<iframe title="Outside city to inside city campaign contributions" aria-label="Grouped Columns" id="datawrapper-chart-fVqiA" src="https://datawrapper.dwcdn.net/fVqiA/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="481" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"]){var e=document.querySelectorAll("iframe");for(var t in a.data["datawrapper-height"])for(var r=0;r<e.length;r++)if(e[r].contentWindow===a.source){var i=a.data["datawrapper-height"][t]+"px";e[r].style.height=i}}}))}();</script>

The following graphs highlight a couple of these candidates, especially Adrian Garcia, who have high out of city campaign donators, it would be interesting to see who these people are. 
